    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            def _env_step(runner_state, unused):
                ...
                rng = jax.random.split(rng, num=config["NUM_ENVS"] + 1)
                ...
                def get_termination_single(index, last_b_obs_s, b_obs_s, duration):
                    terminate_fns = [terminate_cautious, terminate_driven, terminate_playful]
                ...
                new_skill_indices = jax.vmap(skill_selector)(base_obsv, rng[1:])
                ...
                reward_fns_single = [cautious_reward_function, driven_reward_function, playful_reward_function]
