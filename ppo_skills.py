...
def make_train(config):
    ...
    def train(rng):
        ...
        def _update_step(runner_state, unused):
            ...
            mean_intrinsic_reward = traj_batch.reward_i.mean()
            metric['mean_intrinsic_reward'] = mean_intrinsic_reward
            ...
            if config["DEBUG"] and config["USE_WANDB"]:
                ...
                def callback(metric, update_step):
                    ...
                    to_log['mean_intrinsic_reward'] = metric['mean_intrinsic_reward']
